...
const Page = () => {
	return (
		<div className=' space-y-5 lg:p-6 p-4'>
			...
			<p>
				Please note that some links on this website are affiliate links, meaning
				if you decide to click on them and make a purchase, we may earn a small
				commission at no additional cost to you. We recommend these products
				because we have found them to be helpful and useful, not because of the
				small commissions we make if you decide to purchase something. However,
				we are not certified professionals, and the information provided should
				not be considered professional advice. Always perform due diligence
				before purchasing any product or service. Your use of third-party
				websites linked from our website is subject to their privacy policies
				and terms of use, which may differ from ours. We are not responsible for
				the content or availability of any linked websites. Thank you for your
				support which enables us to continue providing high-quality content!
			</p>
		</div>
	);
};
